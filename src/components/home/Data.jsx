...
const Data = () => {
    return (
        <div className="home_data">
            <h1 className="home_title">Abo Da7m
                <svg
                    width="36"
                    height="36"
                    viewBox="0 0 48 48"
            ...
            <p className="home_description">
                Full-stack developer crafting seamless digital experiences from front-end elegance to back-end robustness. 
                <br />(Short, impactful, and showcases your versatility!)
            </p>
